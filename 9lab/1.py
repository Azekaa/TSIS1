...
background = pygame.image.load("C:\\Users\\User\\OneDrive\\Рабочий стол\\pp2\\lab8\\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\\Users\\User\\OneDrive\\Рабочий стол\\pp2\\lab8\\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\\Users\\User\\OneDrive\\Рабочий стол\\pp2\\lab8\\Player.png")
        self.rect = self.image.get_rect()
...
a = pygame.image.load("C:\\Users\\User\\OneDrive\\Рабочий стол\\pp2\\lab8\\coin.png")
...
b = pygame.image.load('C:\\Users\\User\\OneDrive\\Рабочий стол\\pp2\\9lab\\coins.png')
